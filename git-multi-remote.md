# camera-learning 多远程仓库同步指南

> 版本：1.0　作者：chiangyang　更新：2026-09-17

## 1. 概述

camera-learning 代码同时托管在 **Gitee** 和 **GitHub** 两个远程仓库，本地 `master` 分支分别推送为两个平台的分支名：

| 远程名 | 地址 | 协议 | 推送目标分支 |
|--------|------|------|--------------|
| `gitee` | `https://gitee.com/chiangyangNPU/camera-learning.git` | HTTPS | `master` |
| `github` | `git@github.com:ChiangyangNPU/camera-learning.git` | SSH | `main` |
...
git remote add github git@github.com:ChiangyangNPU/camera-learning.git
# git remote add gitee  https://gitee.com/chiangyangNPU/camera-learning.git   # 克隆自 GitHub 时
...
```bash
# 添加远程（已配置，仅作参考）
git remote add gitee  https://gitee.com/chiangyangNPU/camera-learning.git
git remote add github git@github.com:ChiangyangNPU/camera-learning.git
...
# 1. 初始提交
git add -A
git commit -m "Initial commit: camera-learning"
...
```bash
git remote set-url github git@github.com:ChiangyangNPU/camera-learning.git
